...
public class DiffCalculationEngineTest {
    ...
    public void testSameObjects() {
    	...
    	Person dann = TestDataProvider.getPerson(age, name, addresses, attributes);
    	Person sameDann = TestDataProvider.getPerson(age, name, addresses, attributes);
    ...
    public void testChangedObjectWithSimpleAttribute() {
    	...
    	Person dann = TestDataProvider.getPerson(age, name, addresses, attributes);
    	Person changedDann = TestDataProvider.getPerson(changedAge, name, addresses, attributes);
    ...
    public void testChangedObjectWithNullComplexAttribute() {
    	...
    	Person dann = TestDataProvider.getPerson(age, name, addresses, null);
    	Person changedDann = TestDataProvider.getPerson(changedAge, name, addresses, null);
    ...
    public void testChangedObjects() {
        List<Person> afterTestData = TestDataProvider.getAfterPersonList();
		List<Person> beforeTestData = TestDataProvider.getBeforePersonList();
